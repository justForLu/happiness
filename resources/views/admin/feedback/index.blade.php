    ...
    <div class="box">
        <div class="box-header">
            <form action="#" method="get" class="form-horizontal" role="form">
                <div class="col-sm-2">
                    <input type="text" name="name" placeholder="姓名" value="{{ isset($params['name']) ?  $params['name'] : ''}}" class="form-control">
                </div>
                <div class="col-sm-2">
                    <input type="text" name="mobile" placeholder="手机号" value="{{ isset($params['mobile']) ?  $params['mobile'] : ''}}" class="form-control">
                </div>
                <div class="col-sm-2">
                    <input type="text" name="email" placeholder="邮箱" value="{{ isset($params['email']) ?  $params['email'] : ''}}" class="form-control">
                </div>
                <div class="col-sm-2">
                    {{\App\Enums\FeedbackEnum::enumSelect(isset($params['status']) ?  $params['status'] : '','请选择处理状态','status')}}
                </div>
                <div class="col-sm-1">
