...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <form class="form-horizontal J_ajaxForm" style="margin:10px 20px;" role="form" id="form" action="{{url('admin/notebook',array($data->id))}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                {{\App\Enums\NotebookEnum::enumSelect($data->status,false,'status')}}
                            </div>
                        </div>
